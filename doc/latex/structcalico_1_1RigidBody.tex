...
\begin{center}
\leavevmode
\includegraphics[width=241pt]{structcalico_1_1RigidBody__coll__graph}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em F\+R\+OM world TO rigidbody transform, $\mathbf{T}^w_b$. \end{DoxyCompactList}\item 
...
~\newline
T\+O\+D\+O(yangjames)\+: Replace std\+::unordered\+\_\+map with absl\+::flat\+\_\+hash\+\_\+map. 
